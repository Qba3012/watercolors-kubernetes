package ogorkiewicz.jakub.image.metrics;
...
public class RequestTimer {
    ...
    private final String timerName = "api-images-resource-timer";
    private final String timerDescription = "Images resource timer";
